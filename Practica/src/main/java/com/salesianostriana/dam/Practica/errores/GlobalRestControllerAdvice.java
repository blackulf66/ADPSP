package com.salesianostriana.dam.Practica.errores;


import com.salesianostriana.dam.Practica.errores.excepciones.EntityNotFoundException;
import com.salesianostriana.dam.Practica.errores.modelo.ApiError;
import com.salesianostriana.dam.Practica.errores.modelo.ApiSubError;
import com.salesianostriana.dam.Practica.errores.modelo.ApiValidationSubError;
...
public class GlobalRestControllerAdvice extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        return buildApiError("Bastantes Errores en la validaciín", request, ex.getFieldErrors()
